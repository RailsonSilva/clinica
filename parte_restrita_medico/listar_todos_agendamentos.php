...
<head>
    ...
    <style>
        ...
        .tabela-exibicao th {
            height: 35px;
            /* tamanho de cada th/td*/
        }

        .tabela-exibicao thead {
            float: left;
            /*Define a posição da primeira coluna, fixa a esquerda*/
            background: #cad6e4;
        }
        ...
        .tabela-exibicao tbody {
            ...
            /*responsividade da barra em celulares*/
            white-space: nowrap;
            /*Define como é tratado o espaçamento em branco, com o nowrap ele recolhe*/
        }

        .tabela-exibicao tbody tr {
            display: inline-block;
            /*Define a exibição do tbody e tr*/
        }
    </style>
</head>
            ...
            <table class="tabela-exibicao table table-striped table-hover">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        $sql = <<<SQL
                                    SELECT dataConsulta, horario, nome, sexo, email, codigoMedico
                                    FROM agenda                               
                                SQL;
                    ...
                    while ($row = $stmt->fetch()) {
                        ...
                        $data_consulta = $data->format('d/m/Y');
